...
<!-- Mirrored from innovationplans.com/themeforest/sodic1/main.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 May 2023 01:33:24 GMT -->
<head>
        ...
        <section id="about" class="about" data-scroll-index="1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="img">
                            <img src="{{asset('assets/img/about/hero-2.png')}}" alt="">
                        </div>
                    </div>
                            ...
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        ...
                                        <a href="{{asset('assets/img/portfolio/1.jpg')}}" class="popimg">
                            ...
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        ...
                                        <a href="{{asset('assets/img/portfolio/2.jpg')}}" class="popimg">
                                            <span class="icon"><i class="fas fa-plus"></i></span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        ...
                                        <a href="{{asset('assets/img/portfolio/3.jpg')}}" class="popimg">
                                            <span class="icon"><i class="fas fa-plus"></i></span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        ...
                                        <a href="{{asset('assets/img/portfolio/4.jpg')}}" class="popimg">
                                            <span class="icon"><i class="fas fa-plus"></i></span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        ...
                                        <a href="{{asset('assets/img/portfolio/5.jpg')}}" class="popimg">
                                            <span class="icon"><i class="fas fa-plus"></i></span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        ...
                                        <a href="{{asset('assets/img/portfolio/6.jpg')}}" class="popimg">
                                            <span class="icon"><i class="fas fa-plus"></i></span>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="item mb-md50">
                            <div class="post-img">
                                <div class="img">
                                    <img src="{{asset('assets/img/blog/01.jpg')}}" alt="">
                                </div>
                                <div class="tag">
                    ...
                    <div class="col-lg-4">
                        <div class="item mb-md50">
                            <div class="post-img">
                                <div class="img">
                                    <img src="{{asset('assets/img/blog/02.jpg')}}" alt="">
                                </div>
                                <div class="tag">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="post-img">
                                <div class="img">
                                    <img src="{{asset('assets/img/blog/03.jpg')}}" alt="">
                                </div>
                                <div class="tag">
            ...
            <section class="sponsors">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-6">
                            <div class="img">
                                <img src="{{asset('assets/img/sponsors/logo-05.png')}}" alt="">
                            </div>
                        </div>
                        <div class="col-md-2 col-6">
                            <div class="img">
                                <img src="{{asset('assets/img/sponsors/logo-06.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="contact" class="page-contact section-padding" data-scroll-index="6">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form"  action="{{url('/contact/store')}}" method="post">
                                @csrf
                        ...
                        <div class="contact-info">
                            ...
                            <div class="form-gr" >
                                <form action="{{url('/blogs/store')}}" method="POST">
                                    ...
                                    <button type="submit" class="butn butn-bg"><span>SIGN UP</span></button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from innovationplans.com/themeforest/sodic1/main.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 May 2023 01:34:24 GMT -->
</html>