...
<!-- Mirrored from htmlbeans.com/html/oreo/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 May 2023 20:59:33 GMT -->
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>Orea - Ultimate Creative Landing Page</title>
...
<body>
	...
	<div id="wrapper">
		...
		<header id="header">
			<div class="bg-dark container-fluid">
				<div class="top-nav text-right">
					<a href="mailto:&#105;&#110;&#102;&#111;&#064;&#111;&#114;&#101;&#111;&#099;&#111;&#109;&#112;&#097;&#110;&#121;&#046;&#099;&#111;&#109;" class="mail">info@areacompaney.com</a>
			...
			<div class="container-fluid header-holder">
				<!-- logo of the page -->
				<div class="logo">
					<a href="#"><img src="{{asset('assets/images/logo.png')}}" alt="Orea"></a>
				</div>
		...
		<main id="main">
			...
			<section class="main-banner overlay bg-full" style="background-image: url(images/img01.jpg)">
				<div class="caption text-center">
					<span class="title">simple &amp; creative</span>
					<h1>we are <span class="clr">orea</span></h1>
			...
			<section id="about" class="main-holder">
				...
				<div class="holder">
					...
					<div class="col tab-content overlay bg-full" style="background-image: url(images/img02.jpg);">
						<!-- tab1 of the page -->
				...
				<div class="holder">
					...
					<div class="col col3 overlay bg-full" style="background-image: url(images/img03.jpg);"></div>
				</div>
			</section>
						...
						<div class="col-xs-12 tab-content">
							<div id="tab5">
								...
								<div class="img-holder">
									<img src="{{asset('assets/images/img04.png')}}" alt="image description">
								</div>
							</div>
							...
							<div id="tab7">
								...
								<div class="img-holder">
									<img src="{{asset('assets/images/img16.png')}}" alt="image description">
								</div>
							</div>
			...
			<section class="client-sec overlay bg-full" style="background-image: url(images/img05.jpg)">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<ul class="list-unstyled client-logo">
								<li><a href="#"><img src="{{asset('assets/images/logo01.jpg')}}" alt="LOGO"></a></li>
								<li><a href="#"><img src="{{asset('assets/images/logo02.jpg')}}" alt="LOGO"></a></li>
								<li><a href="#"><img src="{{asset('assets/images/logo03.jpg')}}" alt="LOGO"></a></li>
								<li><a href="#"><img src="{{asset('assets/images/logo04.jpg')}}" alt="LOGO"></a></li>
								<li><a href="#"><img src="{{asset('assets/images/logo05.jpg')}}" alt="LOGO"></a></li>
								<li><a href="#"><img src="{{asset('assets/images/logo05.jpg')}}" alt="LOGO"></a></li>
							</ul>
			...
			<section id="works" class="portfolio-sec">
				...
				<div id="masnory-container">
					...
					<div class="col coll1 design">
						<img src="{{asset('assets/images/img06.jpg')}}" alt="image description">
						<div class="box">
							<div class="over text-center">
								<h3 class="heading text-uppercase">creative elements</h3>
								<span class="sub-title">design</span>
								<a href="{{asset('assets/images/img06.jpg')}}" class="icon lightbox"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- col of the page end -->
					...
					<div class="col coll2 illustrate">
						<img src="{{asset('assets/images/img07.jpg')}}" alt="image description">
						<div class="box">
							<div class="over text-center">
								<h3 class="heading text-uppercase">creative elements</h3>
								<span class="sub-title">design</span>
								<a href="{{asset('assets/images/img07.jpg')}}" class="icon lightbox"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- col of the page end -->
					...
					<div class="col coll2 design">
						<img src="{{asset('assets/images/img08.jpg')}}" alt="image description">
						<div class="box">
							<div class="over text-center">
								<h3 class="heading text-uppercase">creative elements</h3>
								<span class="sub-title">design</span>
								<a href="{{asset('assets/images/img08.jpg')}}" class="icon lightbox"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- col of the page end -->
					...
					<div class="col coll1 brand">
						<img src="{{asset('assets/images/img09.jpg')}}" alt="image description">
						<div class="box">
							<div class="over text-center">
								<h3 class="heading text-uppercase">creative elements</h3>
								<span class="sub-title">design</span>
								<a href="{{asset('assets/images/img09.jpg')}}" class="icon lightbox"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- col of the page end -->
					<!-- col of the page -->
					<div class="col coll2 illustrate">
						<img src="{{asset('assets/images/img10.jpg')}}" alt="image description">
						<div class="box">
							<div class="over text-center">
								<h3 class="heading text-uppercase">creative elements</h3>
								<span class="sub-title">design</span>
								<a href="{{asset('assets/images/img10.jpg')}}" class="icon lightbox"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- col of the page end -->
					...
					<div class="col coll2 concept">
						<img src="{{asset('assets/images/img11.jpg')}}" alt="image description">
						<div class="box">
							<div class="over text-center">
								<h3 class="heading text-uppercase">creative elements</h3>
								<span class="sub-title">design</span>
								<a href="{{asset('assets/images/img11.jpg')}}" class="icon lightbox"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- col of the page end -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div id="mc_embed_signup">
								<form action="{{url('/blogs/store')}}" method="POST" id="mc-embedded-subscribe-form"  class=" newsletter-form"  >
									@csrf
							    	<div id="mc_embed_signup_scroll">
							    		...
							    		<div class="clear"><input type="submit"   class="button btn btn2"></div>
							    	</div>
								</form>
							</div>
							<!--End mc_embed_signup-->
			...
			<section class="counter-sec overlay bg-full" style="background-image: url(images/img12.jpg)">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<!-- header of the page -->
				...
				<div class="container team-holder">
					<div class="row">
						<div class="col-xs-12 col-sm-4">
							<!-- team of the page -->
							<div class="team">
								<img src="{{asset('assets/images/img13.jpg')}}" alt="image description">
								<div class="over text-center">
						...
						<div class="col-xs-12 col-sm-4">
							<!-- team of the page -->
							<div class="team">
								<img src="{{asset('assets/images/img14.jpg')}}" alt="image description">
								<div class="over text-center">
									<h3 class="heading text-uppercase"><a href="#">jonathan doe</a></h3>
									<span class="sub-title">web designer</span>
									<ul class="list-unstyled social-network">
						...
						<div class="col-xs-12 col-sm-4">
							<!-- team of the page -->
							<div class="team">
								<img src="{{asset('assets/images/img15.jpg')}}" alt="image description">
								<div class="over text-center">
									<h3 class="heading text-uppercase"><a href="#">jonathan doe</a></h3>
									<span class="sub-title">web designer</span>
									<ul class="list-unstyled social-network">
			...
			<section id="blog" class="blog-sec">
				...
				<div class="holder">
					<div class="img-holder">
						<img src="{{asset('assets/images/img16.jpg')}}" alt="image description">
					</div>
					<!-- post text of the page -->
					<div class="post-text">
						<h3 class="heading text-uppercase">some facts about orea</h3>
				...
				<div class="holder">
					<div class="img-holder alignright">
						<img src="{{asset('assets/images/img17.jpg')}}" alt="image description">
					</div>
					<!-- post text of the page -->
			...
			<section id="contact" class="contact-sec">
				...
				<!-- main header of the page end -->
				<div class="contact-holder overlay bg-full" style="background-image: url(images/img18.jpg)">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-unstyled contact-list">
									...
									<li>
										...
										<span class="mail">
											<a href="www.oreatheme.html">www.oreatheme.com</a>
											<a href="mailto:support@orea.com;">support@orea.com</a>
										</span>
									</li>
									<li>
								...
								<form action="{{url('/contact/store')}}" method="post" class="contact-form">
									@csrf
									<div class="col">
									...
									<div class="col textarea">
										...
										<button type="submit" class="btn btn4" >submit</button>
									</div>
								</form>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						<p>Copyright © 2016 <a href="#">Orea</a>. All Rights Reserved.</p>
					</div>
					<div class="col-xs-12 col-sm-6">
						<!-- social network of the page -->
						<ul class="list-unstyled social-network">
...
<!-- Mirrored from htmlbeans.com/html/oreo/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 May 2023 20:59:42 GMT -->
</html>