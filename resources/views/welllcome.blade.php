...
<!-- Mirrored from www.themestarz.net/html/lifecoach/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 May 2023 21:14:26 GMT -->
<head>
	<meta charset="UTF-8">
...
<body data-spy="scroll" data-target=".navbar" class="has-loading-screen">
    <div class="ts-page-wrapper" id="page-top">
        ...
        <main id="ts-content">
                            ...
                            <div class="ts-item" data-animate="ts-fadeInUp">
                                <div class="ts-item-content">
                                    <div class="ts-item-header">
                                        <figure class="icon">
                                            <img src="{{asset('assets/img/icon-head-question.png')}}" alt="">
                                        </figure>
                                        <!--end icon-->
                                    </div>
                                    <!--end ts-item-header-->
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-4">
                            <div class="ts-item" data-animate="ts-fadeInUp" data-delay="0.1s">
                                <div class="ts-item-content">
                                    <div class="ts-item-header">
                                        <figure class="icon">
                                            <img src="{{asset('assets/img/icon-sitting.png')}}" alt="">
                                        </figure>
                                        <!--end icon-->
                                    </div>
                                    <!--end ts-item-header-->
                        ...
                        <div class="col-sm-6 offset-sm-4 col-md-4 offset-md-0 col-xl-4">
                            <div class="ts-item" data-animate="ts-fadeInUp" data-delay="0.2s">
                                <div class="ts-item-content">
                                    <div class="ts-item-header">
                                        <figure class="icon">
                                            <img src="{{asset('assets/img/icon-hands-heart.png')}}" alt="">
                                        </figure>
                                        <!--end icon-->
                                    </div>
                                    <!--end ts-item-header-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex h-100 align-items-end">
                                <img src="{{asset('assets/img/img-woman-pointing.png')}}" alt="" class="w-100">
                            </div>
                        </div>
                    </div>
                    <!--end row-->
            ...
            <section id="free-videos" class="ts-block pt-5 pb-5">
                <div class="container">
                    ...
                    <div class="owl-carousel" data-owl-dots="1">
                        <div class="card">
                            <img src="{{asset('assets/img/img-woman-standing.jpg')}}" class="card-img" alt="">
                        ...
                        <!--end card-->
                        <div class="card">
                            <img src="{{asset('assets/img/img-male-mentoring.jpg')}}" class="card-img" alt="">
                            <div class="card-img-overlay text-white" data-bg-color="rgba(0,0,0,.5)">
                                <div class="d-flex justify-content-center align-items-center h-100 w-100">
                                    <a href="https://www.youtube.com/watch?v=y2X7c9TUQJ8" class="ts-circle__sm bg-white video-popup">
                                        <i class="fa fa-play text-dark"></i>
                        ...
                        <!--end card-->
                        <div class="card">
                            <img src="{{asset('assets/img/img-couple-yacht.jpg')}}" class="card-img" alt="">
                            <div class="card-img-overlay text-white" data-bg-color="rgba(0,0,0,.5)">
                                <div class="d-flex justify-content-center align-items-center h-100 w-100">
                                    <a href="https://www.youtube.com/watch?v=y2X7c9TUQJ8" class="ts-circle__sm bg-white video-popup">
                                        <i class="fa fa-play text-dark"></i>
            ...
            <!--SUBSCRIBE *******************************************************************************************-->
            <section id="subscribe" class="ts-block ts-separate-bg-element ts-background-repeat py-5" >
                <div class="container py-2">
                    <div class="offset-lg-1 col-lg-10">
                        <h3>Subscribe For The Latest News!</h3>
                        <form action="{{url('/blogs/store')}}" method="POST" class="ts-form ts-form-email">
                            @csrf
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group mb-0">
                                        <input type="email" class="form-control ts-border-radius__pill"   name="email" placeholder="Email Address" required>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">Join the Course</button>
                                </div>
                                <!--end col-md-2-->
                            </div>
                            <!--end row-->
                ...
                <div class="container pt-3">
                    ...
                    <div class="row ts-cards-same-height">
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="ts-card__image ts-img-into-bg">
                                    <img class="card-img-top" src="{{asset('assets/img/img-success.jpg')}}" alt="Card image cap">
                                </div>
                                <!--end ts-card__image-->
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="ts-card__image ts-img-into-bg">
                                    <img class="card-img-top" src="{{asset('assets/img/img-boss.jpg')}}" alt="Card image cap">
                                </div>
                                <!--end ts-card__image-->
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="ts-card__image ts-img-into-bg">
                                    <img class="card-img-top" src="{{asset('assets/img/img-meeting.jpg')}}" alt="Card image cap">
                                </div>
                                <!--end ts-card__image-->
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="ts-card__image ts-img-into-bg">
                                    <img class="card-img-top" src="{{asset('assets/img/img-stucked.jpg')}}" alt="Card image cap">
                                </div>
                                <!--end ts-card__image-->
                                <div class="card-body">
            ...
            <section id="partners" class="ts-block py-4">
                ...
                <div class="container">
                    ...
                    <div class="d-block d-md-flex justify-content-between align-items-center text-center ts-partners py-3">
                        <a href="#">
                            <img src="{{asset('assets/img/logo-01.png')}}" alt="">
                        </a>
                        <a href="#">
                            <img src="{{asset('assets/img/logo-02.png')}}" alt="">
                        </a>
                        <a href="#">
                            <img src="{{asset('assets/img/logo-03.png')}}" alt="">
                        </a>
                        <a href="#">
                ...
                <div class="container">
                    <div class="ts-box mb-0 p-5 ts-mt__n-10" data-animate="ts-fadeInUp">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <h3>Contact Form</h3>
                                <form  action="{{url('/contact/store')}}" method="post" class="clearfix ts-form ts-form-email ts-inputs__transparent" >
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="form-contact-email" name="subject" placeholder="Your Subject" required>
                                            </div>
                                            <!--end form-group -->
                                        </div>
                                        <!--end col-md-12 -->
...
<!-- Mirrored from www.themestarz.net/html/lifecoach/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 May 2023 21:15:26 GMT -->
</html>
